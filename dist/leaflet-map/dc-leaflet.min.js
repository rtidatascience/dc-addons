...
return"string"==typeof a&&(a=a.split(",")),a},a})}(),function(){"use strict";return!dc.leafletChoroplethChart&&void(dc.leafletChoroplethChart=function(a,b){var c=dc.colorChart(dc.baseLeafletChart({})),d=!1,e=[],f=!1,g={fillColor:"black",color:"gray",opacity:.4,fillOpacity:.6,weight:1},h=function(a){return a.key},i=function(a){var b=c.featureOptions();b instanceof Function&&(b=b(a)),b=JSON.parse(JSON.stringify(b));var d=e[c.featureKeyAccessor()(a)];return d&&d.d&&(b.fillColor=c.getColor(d.d,d.i),c.filters().indexOf(d.d.key)!==-1&&(b.opacity=.8,b.fillOpacity=1)),b};c._postRender=function(){d=L.geoJson(c.geojson(),{style:c.featureStyle(),onEachFeature:j}),c.map().addLayer(d)},c._doRedraw=function(){d.clearLayers(),e=[],c._computeOrderedGroups(c.data()).forEach(function(a,b){e[c.keyAccessor()(a)]={d:a,i:b}}),d.addData(c.geojson())},c.geojson=function(a){return arguments.length?(f=a,c):f},c.featureOptions=function(a){return arguments.length?(g=a,c):g},c.featureKeyAccessor=function(a){return arguments.length?(h=a,c):h},c.featureStyle=function(a){return arguments.length?(i=a,c):i};var j=function(a,b){var d=e[c.featureKeyAccessor()(a)];d&&d.d&&(b.key=d.d.key,c.renderPopup()&&b.bindPopup(c.popup()(d.d,a)),c.brushOn()&&b.on("click",k))},k=function(a){if(a.target){var b=a.target.key;dc.events.trigger(function(){c.filter(b),dc.redrawAll(c.chartGroup())})}};return c.anchor(a,b)})}(),function(){"use strict";return!dc.leafletMarkerChart&&void(dc.leafletMarkerChart=function(a,b){var c=dc.baseLeafletChart({}),d=!1,e=!1,f=!1,g=!0,h=!1,i=!1,j=!1,k=!1,l={},m=!1,n=!0,o=!1,p=!1,q=!0,r=!1;c.renderTitle(!0);var s=function(a){return c.keyAccessor()(a)},t=function(a){var b=new L.Marker(c.toLocArray(c.locationAccessor()(a)),{title:c.renderTitle()?c.title()(a):"",alt:c.renderTitle()?c.title()(a):"",icon:u(a,c.map()),clickable:c.renderPopup()||c.brushOn()&&!h,draggable:!1});return b},u=function(a,b){return new L.Icon.Default},v=function(a,b){return c.title()(a)};c._postRender=function(){c.brushOn()&&(h&&c.filterHandler(z),c.map().on("zoomend moveend",y,this),h||c.map().on("click",y,this),c.map().on("zoomstart",x,this)),k=d?new L.MarkerClusterGroup(e?e:null):new L.LayerGroup,c.map().addLayer(k)},c._doRedraw=function(){var a=c._computeOrderedGroups(c.data()).filter(function(a){return 0!==c.valueAccessor()(a)});if(!m||m.toString()!==a.toString()){m=a,f&&(l={}),k.clearLayers();var b=[];if(a.forEach(function(a,d){var e=c.keyAccessor()(a),g=null;g=!f&&e in l?l[e]:w(a,e),c.cluster()?b.push(g):k.addLayer(g)}),c.cluster()&&b.length>0&&k.addLayers(b),b.length>0&&(n||o&&!p)){var d=new L.featureGroup(b);c.map().fitBounds(d.getBounds())}p=!1,n=!1}},c.locationAccessor=function(a){return arguments.length?(s=a,c):s},c.marker=function(a){return arguments.length?(t=a,c):t},c.icon=function(a){return arguments.length?(u=a,c):u},c.popup=function(a){return arguments.length?(v=a,c):v},c.renderPopup=function(a){return arguments.length?(q=a,c):q},c.popupOnHover=function(a){return arguments.length?(r=a,c):r},c.cluster=function(a){return arguments.length?(d=a,c):d},c.clusterOptions=function(a){return arguments.length?(e=a,c):e},c.rebuildMarkers=function(a){return arguments.length?(f=a,c):f},c.brushOn=function(a){return arguments.length?(g=a,c):g},c.filterByArea=function(a){return arguments.length?(h=a,c):h},c.fitOnRender=function(a){return arguments.length?(n=a,c):n},c.fitOnRedraw=function(a){return arguments.length?(o=a,c):o},c.markerGroup=function(){return k};var w=function(a,b){var d=t(a);return d.key=b,c.renderPopup()&&(d.bindPopup(c.popup()(a,d)),c.popupOnHover()&&(d.on("mouseover",function(){d.openPopup()}),d.on("mouseout",function(){d.closePopup()}))),c.brushOn()&&!h&&d.on("click",B),l[b]=d,d},x=function(a){j=!0},y=function(a){if("moveend"!==a.type||!j&&!a.hard)if(j=!1,p=!0,h){var b;b=c.map().getCenter().equals(c.center())&&c.map().getZoom()===c.zoom()?null:c.map().getBounds(),dc.events.trigger(function(){c.filter(null),b&&(i=!0,c.filter(b),i=!1),dc.redrawAll(c.chartGroup())})}else c.filter()&&("click"===a.type||l.hasOwnProperty(c.filter())&&!c.map().getBounds().contains(l[c.filter()].getLatLng()))&&dc.events.trigger(function(){c.filter(null),q&&c.map().closePopup(),dc.redrawAll(c.chartGroup())})},z=function(a,b){p=!0,c.dimension().filter(null),b&&b.length>0&&(c.dimension().filterFunction(function(a){if(!(a in l))return!1;var c=l[a].getLatLng();return c&&b[0].contains(c)}),i||c.map().getBounds().toString===b[0].toString()||c.map().fitBounds(b[0]))};dc.override(c,"filter",function(a){return arguments.length?(A(a),void c._filter(a)):(A(),c._filter())});var A=function(a){if(arguments.length&&null!==a)if(c.filters().length){var b=!1;c.filters().forEach(function(c){c===a&&(b=!0)}),l[a].setOpacity(b?.3:1)}else Object.keys(l).forEach(function(b){b!==a&&l[b].setOpacity(.3)});else Object.keys(l).forEach(function(a){l[a].setOpacity(1)})},B=function(a){if(a.target){p=!0;var b=a.target.key;dc.events.trigger(function(){c.filter(b),dc.redrawAll(c.chartGroup())})}};return c.anchor(a,b)})}(),function(){"use strict";return!dc.leafletCustomChart&&void(dc.leafletCustomChart=function(a,b){var c=dc.baseLeafletChart({}),d=null,e=null;return c.renderTitle(!0),c._postRender=function(){var a=c._computeOrderedGroups(c.data());a.forEach(function(a,b){c.renderItem()(c,c.map(),a,b)})},c._doRedraw=function(){var a=c._computeOrderedGroups(c.data()),b=c.valueAccessor();a.forEach(function(a,d){a.filtered=0===b(a),c.redrawItem()(c,c.map(),a,d)})},c.redrawItem=function(a){return arguments.length?(d=a,c):d},c.renderItem=function(a){return arguments.length?(e=a,c):e},c.anchor(a,b)})}(),
