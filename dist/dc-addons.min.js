...
c.chart=c.chart,c.resize()}},c.resize=function(){try{c.chart.data().length>0&&(c.chart.root().select("svg").attr("width","100%"),a(function(){c.chart.hasOwnProperty("rescale")&&c.chart.rescale(),dc.redrawAll()},100))}catch(a){}},c.cleanup=function(){c.chart&&dc.deregisterChart(c.chart)},
//--------------------
// watchers
//--------------------
